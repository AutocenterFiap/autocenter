...
@DisplayName("RemoverServicoDaOrdemServicoUseCase - Testes Unitários")
class RemoverServicoDaOrdemServicoUseCaseTest {
    ...
    @InjectMocks
    private RemoverServicoDaOrdemServicoUseCase useCase;
    ...
    void setUp() {
        ordemServicoEmDiagnostico = OrdemServico.builder()
                .id(1L).statusOS(StatusOS.EM_DIAGNOSTICO).build();
    }
    ...
    @Test
    @DisplayName("Deve remover o serviço quando a OS e o item estiverem em estado válido")
    void deveRemoverServicoComSucesso() {
        ...
        useCase.executar(1L, 50L);

        verify(itemServicoRepositoryPort).deleteById(700L);
    }
    ...
    void deveLancarExcecaoQuandoOrdemServicoNaoEncontrada() {
        ...
        verify(itemServicoRepositoryPort, never()).deleteById(any());
    }
