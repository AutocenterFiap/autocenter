...
public class AprovarOrcamentoUseCase {
    ...
    public AprovarOrcamentoUseCase(OrcamentoRepositoryPort orcamentoRepositoryPort, OrdemServicoRepositoryPort ordemServicoRepositoryPort) {
    ...
    public OrcamentoOutput executar(Long id) {
        ...
        orcamento.aprovar();
        this.aprovarOrderServico(orcamento.getOrdemServicoId());
    ...
    private void aprovarOrderServico(Long ordemServicoId) {
        this.ordemServicoRepositoryPort.findById(ordemServicoId).ifPresent(OrdemServico::aprovar);
    }
